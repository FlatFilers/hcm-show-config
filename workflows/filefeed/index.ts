...
export default function (listener) {
  ...
  listener.filter({ job: 'space:configure' }, (configure) => {
    ...
    <p style="margin-top: 0px; margin-bottom: 8px;">Click on the "Benefit Elections" workbook in the left-hand sidebar. This will display the data that has been mapped and transformed from the Google Drive file.</p>
    <h2 style="margin-bottom: 0px;">3. Confirm the Data Load into HCM.Show</h2>
    <p style="margin-top: 0px; margin-bottom: 12px;">As part of this process, we've automatically uploaded a file, mapped the data, and loaded this data into HCM Show. All you need to do is confirm it.</p>
