...

      {
        ...
        config: {
          options: [
            ...
            {
              value: 'Insurance_Coverage_Type_Voluntary_Supplemental_Life',
            ...
            {
              value: 'Retirement_Savings_Coverage_Type_Defined_Contribution',
            ...
            {
              value: 'Retirement_Savings_Coverage_Type_New_Zealand_Pension',
            ...
            {
              value: 'Additional_Benefits_Coverage_Type_Commuter_Spending',
              label: 'Commuter Spending',
            },
            {
              value: 'Additional_Benefits_Coverage_Type_Charitable_Giving',
